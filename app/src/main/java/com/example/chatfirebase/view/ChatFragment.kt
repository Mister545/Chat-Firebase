...
import com.example.chatfirebase.view.adapters.RcMassage
...
import com.example.chatfirebase.viewModel.ChatViewModel
import com.example.chatfirebase.viewModel.ChatViewModelFactory
...
class ChatFragment : Fragment() {
    ...
    private val viewModel: ChatViewModel by lazy {
        ViewModelProvider(
            this,
            ChatViewModelFactory(FirebaseRepositoryImpl())
    ...
    private fun initRcView(messages: ArrayList<Pair<String, Message>>, chatId: String?) {
    ...
    private fun initChatToolbar(partner: User?) {
    ...
    private fun initGropeToolbar(chat: Chat) {
