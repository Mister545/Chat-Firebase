...
class RcMassage(
    private val onEdit: (Pair<String, MessageModel>) -> Unit,
    private val onDelete: (Pair<String, MessageModel>) -> Unit
) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    private var messages = arrayListOf<Pair<String, MessageModel>>()
    ...
    inner class ReceivedMessageViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        @SuppressLint("NewApi")
        fun bind(message: Pair<String, MessageModel>) {
        ...
        private fun getAllData(massageModel: MessageModel, callback: (MessageModel, UserModel) -> Unit) {
    ...
    fun setList(list: ArrayList<Pair<String, MessageModel>>) {
        messages = list
        notifyDataSetChanged()
    }

    private fun showPopupMenu(view: View, message: Pair<String, MessageModel>, isSent: Boolean) {
